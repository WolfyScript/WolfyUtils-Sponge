package com.wolfyscript.utilities.sponge.gui.example;
                        ...
                        .construct(rendering -> {
                            ...
                            rendering
                                    ...
                                    .renderAt(4, "count_up", ButtonBuilder.class, settingsBtn -> settingsBtn
                                            .icon(icon -> icon
                                                    .stack(() -> {
                                                        var config = new SpongeItemStackConfig(core.getWolfyUtils(), "minecraft:green_concrete");
                                    ...
                                    .renderAt(13, "counter", ButtonBuilder.class, settingsBtn -> settingsBtn
                                            .icon(icon -> icon
                                                    .stack(() -> {
                                                        var config = new SpongeItemStackConfig(core.getWolfyUtils(), "minecraft:redstone");
                                    ...
                                    .reactive(reactiveBuilder -> {
                                        if (count.get() > 0) {
                                            ...
                                            return reactiveBuilder
                                                    .render("ff", ComponentClusterBuilder.class, builder1 -> builder1
                                                            .renderAt(22, "count_down", ButtonBuilder.class, buttonBuilder -> buttonBuilder
                                                                    .icon(icon -> icon
                                                                            .stack(() -> {
                                                                                SpongeItemStackConfig config = new SpongeItemStackConfig(core.getWolfyUtils(), "minecraft:red_concrete");
                                                            ...
                                                            .renderAt(10, "reset", ButtonBuilder.class, buttonBuilder -> buttonBuilder
                                                                    .icon(icon -> icon.stack(() -> {
                                                                        SpongeItemStackConfig config = new SpongeItemStackConfig(core.getWolfyUtils(), "minecraft:tnt");
                        ...
                        .construct((renderer) -> {
                            ...
                            renderer
                                    ...
                                    .reactive(reactiveBuilder -> {
                                        if (count.get() > 0) {
                                            reactiveBuilder
                                                    .render("test", ComponentClusterBuilder.class, builder1 -> builder1
