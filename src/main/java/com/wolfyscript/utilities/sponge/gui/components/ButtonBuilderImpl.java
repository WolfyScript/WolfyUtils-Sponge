...
public class ButtonBuilderImpl extends AbstractComponentBuilderImpl<Button, Component> implements ButtonBuilder {
    ...
    public static class IconBuilderImpl implements IconBuilder {
        ...
        @JsonProperty("stack")
        private SpongeItemStackConfig stackConfig;
         ...
         */
        @JsonCreator
        public IconBuilderImpl(@JsonProperty("stack") SpongeItemStackConfig stackConfig) {
            this.stackConfig = stackConfig;
        }

        @JsonSetter("stack")
        private void setStack(SpongeItemStackConfig config) {
        ...
        public IconBuilder stack(SerializableSupplier<ItemStackConfig<?>> supplier) {
            if (supplier.get() instanceof SpongeItemStackConfig bukkitItemStackConfig) {
                this.stackConfig = bukkitItemStackConfig;
            }
            return this;
        }
